...
export default function HomePage(){
    ...
    return(<>
        <div className="grid grid-cols-12 gap-5"> 
            <div className="col-span-8 mainInfo">
        ...
        <div className="grid grid-cols-9 gap-5 functionalities">
            <div className="card col-span-3">
                <div className="grid grid-cols-3 gap-3 items-center">
                    <div className="col-span-1">
                        <img src="/images/compass.png" alt="opened book with a quill inside a compass"/>
                    </div>
            ...
            <div className="card col-span-3">
                <div className="grid grid-cols-3 gap-3 items-center">
                    <div className="col-span-1">
                        <img src="/images/globe.png" alt="opened book with a quill inside a compass"/>
                    </div>
                    <div className="col-span-2">
            ...
            <div className="card col-span-3">
                <div className="grid grid-cols-3 gap-3 items-center">
                    <div className="col-span-1">
                        <img src="/images/book.png" alt="opened book with a quill inside a compass"/>
                    </div>
                    <div className="col-span-2">
