...
public class ExperienceRestControllerTest {
    ...
    void testGetExperiences(){
        List<ExperienceSimpleDTO> mapped = List.of(
                new ExperienceSimpleDTO(null, LocalDate.now(), 6F, "Experiencia 1", "Descripcion 1", Category.Accommodation),
                new ExperienceSimpleDTO(null, LocalDate.now(), 8.67F, "Experiencia 2", "Descripcion 2", Category.Culture),
                new ExperienceSimpleDTO(null, LocalDate.now(), 5.1F, "Experiencia 3", "Descripcion 3", Category.Personal_Experience),
                new ExperienceSimpleDTO(null, LocalDate.now(), 1.9F, "Experiencia 4", "Descripcion 4", Category.Social_Events)
        );
